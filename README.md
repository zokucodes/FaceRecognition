😃 A face recognition app that recognizes a face when you provide an image, for example if you send a picture of a selfie of yourself then the app will detect and highlight where your face is.
